...
{
    public class BCPMain : Network
    {
        public BCPMain()
        {
            CoinSetup setup = BCPSetup.Instance.Setup;
            NetworkSetup network = BCPSetup.Instance.Main;

            this.NetworkType = NetworkType.Mainnet;
            this.DefaultConfigFilename = setup.ConfigFileName; // The default name used for the BCP configuration file.
            ...
            this.StandardScriptsRegistry = new BCPStandardScriptsRegistry();
