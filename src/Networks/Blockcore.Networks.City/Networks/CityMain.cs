...
namespace Blockcore.Networks.City.Networks
{
    public class CityMain : Network
    {
        public CityMain()
        {
            ...
            this.DefaultConfigFilename = setup.ConfigFileName; // The default name used for the City configuration file.
            ...
            this.Consensus.PosEmptyCoinbase = CitySetup.Instance.IsPoSv3();
            this.Consensus.PosUseTimeFieldInKernalHash = CitySetup.Instance.IsPoSv3();
