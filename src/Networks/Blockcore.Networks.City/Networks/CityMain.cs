    ...
    public class CityMain : Network
    {
        public CityMain()
        {
            ...
            var bip9Deployments = new CityBIP9Deployments()
            {
                ...
                [CityBIP9Deployments.CSV] = new BIP9DeploymentsParameters("CSV", 0, new DateTime(2021, 4, 12, 0, 0, 0, DateTimeKind.Utc), new DateTime(2021, 6, 1, 0, 0, 0, DateTimeKind.Utc), BIP9DeploymentsParameters.DefaultTestnetThreshold),
                [CityBIP9Deployments.Segwit] = new BIP9DeploymentsParameters("Segwit", 1, new DateTime(2021, 4, 12, 0, 0, 0, DateTimeKind.Utc), new DateTime(2021, 6, 1, 0, 0, 0, DateTimeKind.Utc), BIP9DeploymentsParameters.DefaultTestnetThreshold),
            };
