...
namespace Stratis.Bitcoin.Features.MemoryPool.Tests.PoS
{
    /// <summary>
    ...
    public class StratisMempoolValidatorTest : TestBase
    {
        ...
        public async Task AcceptToMemoryPool_WithMultiInOutValidTxns_IsSuccessfulAsync()
        {
            ...
            Transaction multiOutputTx = txBuilder
                ...
                .AddKeys(miner)
                .Send(satoshi.GetAddress(), "0.10")
                .Send(bob.GetAddress(), "0.20")
                .Send(alice.GetAddress(), "0.15")
                .SendFees("0.001")
            ...
            Transaction multiInputTx = txBuilder
                .AddCoins(aliceCoins)
                .AddKeys(alice)
                .Send(satoshi.GetAddress(), "0.08")
                .SetChange(alice.GetAddress())
                .SendFees("0.0005")
                .Then()
                .AddCoins(bobCoins)
                .AddKeys(bob)
                .Send(satoshi.GetAddress(), "0.02")
