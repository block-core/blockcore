...
namespace Blockcore.Networks.SeniorBlockCoin.Networks.Rules
{
   /// <summary>
   /// Checks if <see cref="SeniorBlockCoinMain"/> network block's header has a valid block version.
   /// </summary>
   public class SeniorBlockCoinHeaderVersionRule : HeaderVersionRule
   {
      /// <inheritdoc />
      ...
      public override void Run(RuleContext context)
      {
         ...
         // block versions above 7 and below 0x25006000.
