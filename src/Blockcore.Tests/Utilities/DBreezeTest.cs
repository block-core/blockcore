...
namespace Blockcore.Tests.Utilities
{
    ...
    public class DBreezeTest : TestBase
    {
        ...
        public void DeserializerWithCoinsDeserializesObject()
        {
            ...
            var coins = new Blockcore.Utilities.Coins(0, genesis.Transactions[0].Outputs.First(), true);

            var result = (Blockcore.Utilities.Coins)this.dbreezeSerializer.Deserialize(coins.ToBytes(KnownNetworks.StratisRegTest.Consensus.ConsensusFactory), typeof(Blockcore.Utilities.Coins));
