...
namespace Blockcore.Networks.Cybits.Rules
{
   /// <summary>
   /// Checks if <see cref="CybitsMain"/> network block's header has a valid block version.
   /// </summary>
   public class CybitsHeaderVersionRule : HeaderVersionRule
   {
      /// <inheritdoc />
