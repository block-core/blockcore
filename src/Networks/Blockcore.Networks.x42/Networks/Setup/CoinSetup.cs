...
namespace Blockcore.Networks.x42.Networks.Setup
{
    internal class CoinSetup
    {
        ...
        internal long SubsidyLimit;
        internal Money LastProofOfStakeRewardHeight;
        internal bool BlocksWithoutRewards;
        internal Money ProofOfStakeRewardAfterSubsidyLimit;
    }
