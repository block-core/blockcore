...
namespace Blockcore.Tests.Consensus
{
    public class ConsensusManagerTests
    {
        ...
        public void BlockDownloaded_CallbackRegisteredForHash_UnknownHeader_BlockNotExpected_ThrowsInvalidOperationException()
        {
            ...
            var callback = new Blockcore.Consensus.OnBlockDownloadedCallback(d => { callbackCalled = true; });
        ...
        public void BlockDownloaded_KnownHeader_BlockIntegrityInvalidated_BansPeer_DoesNotCallCallback()
        {
            ...
            builder.IntegrityValidator.Setup(i => i.VerifyBlockIntegrity(additionalHeaders, additionalHeaders.Block))
                .Returns(new Blockcore.Consensus.ValidationContext()
                {
                    BanDurationSeconds = 3000,
                    Error = Blockcore.Consensus.ConsensusErrors.BadBlockSignature
                });
        ...
        public void BlockDownloaded_ExpectedBlockDataBytesCalculatedCorrectly()
        {
            ...
            var callback1 = new Blockcore.Consensus.OnBlockDownloadedCallback(d => { callback1Called = true; });
            var callback2 = new Blockcore.Consensus.OnBlockDownloadedCallback(d => { callback2Called = true; });
        ...
        public void BlockDownloaded_NullBlock_CallsCallbacks()
        {
            ...
            var callback1 = new Blockcore.Consensus.OnBlockDownloadedCallback(d => { callback1Called = true; calledWith1 = d; });
            var callback2 = new Blockcore.Consensus.OnBlockDownloadedCallback(d => { callback2Called = true; calledWith2 = d; });
            var callback3 = new Blockcore.Consensus.OnBlockDownloadedCallback(d => { callback3Called = true; calledWith3 = d; });
        ...
        public void GetOrDownloadBlocksAsync_ChainedHeaderBlockNotInCT_CallsBlockDownloadedCallbackForBlock_BlocksNotDownloaded()
        {
            ...
            var blockDownloadedCallback = new Blockcore.Consensus.OnBlockDownloadedCallback(d => { callbackCalled = true; calledWith = d; });
        ...
        public void BlockMinedAsync_CorrectPreviousTip_PartialValidationError_ThrowsConsensusException()
        {
            ...
            builder.PartialValidator.Setup(p => p.ValidateAsync(It.Is<ChainedHeader>(c => c.Block == additionalHeaders.Block), additionalHeaders.Block))
                .ReturnsAsync(new Blockcore.Consensus.ValidationContext()
                {
                    Error = Blockcore.Consensus.ConsensusErrors.BadBlockSignature
                });

            Assert.Throws<Blockcore.Consensus.ConsensusException>(() => builder.TestConsensusManager.ConsensusManager.BlockMinedAsync(additionalHeaders.Block).GetAwaiter().GetResult());
        ...
        public void OnPartialValidationCompletedCallbackAsync_PartialValidationFails_BansPeer()
        {
            ...
            builder.PartialValidator.Setup(p => p.StartPartialValidation(It.IsAny<ChainedHeader>(), It.IsAny<Block>(), It.IsAny<OnPartialValidationCompletedAsyncCallback>()))
                ...
                {
                    callback(new Blockcore.Consensus.ValidationContext()
                    {
                        BanDurationSeconds = 3000,
                        BlockToValidate = block,
                        ChainedHeaderToValidate = header,
                        Error = Blockcore.Consensus.ConsensusErrors.BadTransactionScriptError
                    });
                });
