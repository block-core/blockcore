...
namespace Blockcore.Networks.RoyalSportsCity.Networks.Rules
{
   /// <summary>
   /// Checks if <see cref="RoyalSportsCityMain"/> network block's header has a valid block version.
   /// </summary>
   public class RoyalSportsCityHeaderVersionRule : HeaderVersionRule
   {
      /// <inheritdoc />
      ...
      public override void Run(RuleContext context)
      {
         ...
         // block versions above 7 and below 0x24001000.
