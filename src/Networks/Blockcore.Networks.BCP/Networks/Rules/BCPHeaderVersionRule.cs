...
namespace Blockcore.Networks.BCP.Networks.Rules
{
    /// <summary>
    /// Checks if <see cref="BCPMain"/> network block's header has a valid block version.
    /// </summary>
    public class BCPHeaderVersionRule : HeaderVersionRule
    {
        /// <inheritdoc />
