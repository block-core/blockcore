...
using Terracoin.Networks.Policies;
using Terracoin.Networks.Rules;
using NBitcoin;
...
using Terracoin.Networks.Deployments;

namespace Terracoin.Networks
{
   public class TerracoinMain : Network
   {
      public TerracoinMain()
      {
         CoinSetup setup = TerracoinSetup.Instance.Setup;
         NetworkSetup network = TerracoinSetup.Instance.Main;

         NetworkType = NetworkType.Mainnet;
         DefaultConfigFilename = setup.ConfigFileName; // The default name used for the Terracoin configuration file.
         ...
         var bip9Deployments = new TerracoinBIP9Deployments()
         {
            [TerracoinBIP9Deployments.ColdStaking] = new BIP9DeploymentsParameters("ColdStaking", 2,
         ...
         Consensus.PosEmptyCoinbase = TerracoinSetup.Instance.IsPoSv3();
         Consensus.PosUseTimeFieldInKernalHash = TerracoinSetup.Instance.IsPoSv3();
         ...
         StandardScriptsRegistry = new TerracoinStandardScriptsRegistry();
      ...
      protected void RegisterRules(IConsensus consensus)
      {
         consensus.ConsensusRules
             ...
             .Register<TerracoinHeaderVersionRule>()
