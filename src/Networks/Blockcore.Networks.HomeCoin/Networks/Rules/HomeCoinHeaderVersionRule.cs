...
namespace HomeCoin.Networks.Rules
{
    /// <summary>
    /// Checks if <see cref="HomeCoinMain"/> network block's header has a valid block version.
    /// </summary>
    public class HomeCoinHeaderVersionRule : HeaderVersionRule
    {
        /// <inheritdoc />
