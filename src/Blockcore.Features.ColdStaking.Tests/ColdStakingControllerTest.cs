...
namespace Blockcore.Features.ColdStaking.Tests
{
    ...
    public class ColdStakingControllerTest : TestBase
    {
        ...
        public void GetColdStakingAddressForMissingAccountThrowsWalletException()
        {
            ...
            Assert.StartsWith($"{nameof(Blockcore)}.{nameof(Features)}.{nameof(Wallet)}.{nameof(WalletException)}", error1.Description);
            ...
            Assert.StartsWith($"{nameof(Blockcore)}.{nameof(Features)}.{nameof(Wallet)}.{nameof(WalletException)}", error2.Description);
        ...
        public void SetupColdStakingWithSameWalletThrowsWalletException()
        {
            ...
            Assert.StartsWith($"{nameof(Blockcore)}.{nameof(Features)}.{nameof(Wallet)}.{nameof(WalletException)}", error.Description);
        ...
        public void ColdStakingScriptWithdrawalToSegwitWithColdWalletSucceeds()
        {
            ...
            // activate segwit
            BIP9DeploymentsParameters current = this.Network.Consensus.BIP9Deployments[Blockcore.Networks.Deployments.StratisBIP9Deployments.Segwit];
            this.Network.Consensus.BIP9Deployments[Blockcore.Networks.Deployments.StratisBIP9Deployments.Segwit] =
            ...
            // Revert back changes
            this.Network.Consensus.BIP9Deployments[Blockcore.Networks.Deployments.StratisBIP9Deployments.Segwit] = current;
        }
