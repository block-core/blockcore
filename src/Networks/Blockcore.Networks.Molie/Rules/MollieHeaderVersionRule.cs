...
namespace Blockcore.Networks.Molie.Rules
{
   /// <summary>
   /// Checks if <see cref="MolieMain"/> network block's header has a valid block version.
   /// </summary>
   public class MolieHeaderVersionRule : HeaderVersionRule
   {
      /// <inheritdoc />
      ...
      public override void Run(RuleContext context)
      {
         ...
         // block versions above 7 and below 0x16171000.
