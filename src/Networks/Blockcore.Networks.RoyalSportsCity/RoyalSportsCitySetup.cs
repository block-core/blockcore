...
namespace Blockcore.Networks.RoyalSportsCity
{
    internal class RoyalSportsCitySetup
    {
        ...
        internal NetworkSetup Main = new NetworkSetup
        {
            ...
            DNS = new[] { "seed1.royalsportscity.com", "seed2.royalsportscity.com" },
        ...
        internal NetworkSetup RegTest = new NetworkSetup
        {
            ...
            DNS = new[] { "seedregtest1.royalsportscity.com", "seedregtest2.royalsportscity.com" },
            Nodes = new[] { "130.185.120.45", "185.235.43.17" },
            Checkpoints = new Dictionary<int, CheckpointInfo>
            {
                // TODO: Add checkpoints as the network progresses.
        ...
        internal NetworkSetup Test = new NetworkSetup
        {
            ...
            DNS = new[] { "seedtest1.royalsportscity.com", "seedtest2.royalsportscity.com" },
            Nodes = new[] { "130.185.120.45", "185.235.43.17" },
            Checkpoints = new Dictionary<int, CheckpointInfo>
            {
                // TODO: Add checkpoints as the network progresses.
