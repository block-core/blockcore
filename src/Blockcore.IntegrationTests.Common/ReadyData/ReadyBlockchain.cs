...
namespace Stratis.Bitcoin.IntegrationTests.Common.ReadyData
{
    ...
    /// </summary>
    /// <remarks>
    /// The data in this folder is AUTO-GENERATED by <see cref="GenerateChain"/> class.
    /// </remarks>
    public class ReadyBlockchain
    {
        ...
        public static string StratisMainnet9500 = @"ReadyData/StratisMain9500.zip"; // in order to regenerate use mainchain data 
    }
}
